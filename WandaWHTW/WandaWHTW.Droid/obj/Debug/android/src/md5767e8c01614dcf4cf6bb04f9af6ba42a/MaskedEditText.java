package md5767e8c01614dcf4cf6bb04f9af6ba42a;
...
/** @hide */
	...
	static {
		__md_methods = 
			"n_getOnFocusChangeListener:()Landroid/view/View$OnFocusChangeListener;:GetGetOnFocusChangeListenerHandler\n" +
			"n_setOnFocusChangeListener:(Landroid/view/View$OnFocusChangeListener;)V:GetSetOnFocusChangeListener_Landroid_view_View_OnFocusChangeListener_Handler\n" +
			...
			"";
		mono.android.Runtime.register ("MaskedEditText.MaskedEditText, MaskedEditText, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MaskedEditText.class, __md_methods);
	}


	public MaskedEditText (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == MaskedEditText.class)
			mono.android.TypeManager.Activate ("MaskedEditText.MaskedEditText, MaskedEditText, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public MaskedEditText (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == MaskedEditText.class)
			mono.android.TypeManager.Activate ("MaskedEditText.MaskedEditText, MaskedEditText, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}


	public MaskedEditText (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == MaskedEditText.class)
	...
	public MaskedEditText (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == MaskedEditText.class)
	...
	{
		return n_getOnFocusChangeListener ();
	}

	private native android.view.View.OnFocusChangeListener n_getOnFocusChangeListener ();


	public void setOnFocusChangeListener (android.view.View.OnFocusChangeListener p0)
	{
		n_setOnFocusChangeListener (p0);
	}

	private native void n_setOnFocusChangeListener (android.view.View.OnFocusChangeListener p0);
